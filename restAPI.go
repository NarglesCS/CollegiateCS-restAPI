...
func handleRequests() {
	...
	myRouter.HandleFunc("/Results", showResults).Methods("GET")   //Service for the results page					-Ready for SQL testing

	log.Fatal(http.ListenAndServe(":8000", myRouter))
}

func main() {
	//sqlmanager.InitialMigration() All Tables initialized with mock data
